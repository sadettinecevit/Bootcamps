        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeToBeFriend = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TimeToSent = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldMessageTypeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SendTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OldMessageText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OldImageURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OldVideoURL = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpdatedMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UpdatedMessages_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UpdatedMessages_MessageTypes_OldMessageTypeId",
                        column: x => x.OldMessageTypeId,
                        principalTable: "MessageTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpdatedMessages_MessageId",
                table: "UpdatedMessages",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdatedMessages_OldMessageTypeId",
                table: "UpdatedMessages",
                column: "OldMessageTypeId");
